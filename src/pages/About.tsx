...
const About = () => {
  ...
  return (
    <div className={pageStyles.mainBackground}>
      ...
      {/* Content container with adjusted width */}
      <div className="relative max-w-6xl mx-auto p-6">
        <div className="md:w-1/2 p-4">
          ...
          <div className="space-y-6">
            ...
            <div className="pt-4">
              <h2 className={pageStyles.subheading}>Skills</h2>
              <ul className="grid grid-cols-2 gap-2 mt-3">
                <li className="font-['Montserrat'] text-gray-700 flex items-center">
                  <span className="w-2 h-2 bg-[#d1385b] rounded-full mr-2"></span>
                  Photography
                </li>
                <li className="font-['Montserrat'] text-gray-700 flex items-center">
                  <span className="w-2 h-2 bg-[#d1385b] rounded-full mr-2"></span>
